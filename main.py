...
def main():
    ...
    # program runs.
    print(colored('\nAll the packages have been delivered!', attrs=['bold']))
    ...
    while prompt:
        try:
            ...
            while not correct_time:
                ...
                if not 8 <= hr <= 17:
                    print(colored('\nPlease enter valid hour.', 'red', attrs=['bold']))
                else:
                    minutes = int(input("Minute (0-59): "))
                    if not 0 <= minutes <= 59 or (hr == 17 and minutes != 0):
                        print(colored('\nPlease enter valid minite.', 'red', attrs=['bold']))
                    else:
                        correct_time = True
        ...
        # ends here in the except statement.
            ...
            print(colored('\nThank you! Have a great day.', attrs=['bold']))
            prompt = False

#lists of correct username and password
